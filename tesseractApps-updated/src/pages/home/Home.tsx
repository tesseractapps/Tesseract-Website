...
import SCAnnouncementModal from "../../components/ui/scAnnouncementModal/SCAnnouncementModal";
          ...
          <section id="hv4-hero">
            ...
            <div className="hv4-hero-inner">
              ...
              <div className="hv4-hero-ctas">
                <button type="button" className="hv4-btn-primary" onClick={() => { trackCTAClick("book_demo", "hero", "/"); navigate("/book-a-demo"); }}>
                  Book a Demo
                </button>
                <button type="button" className="hv4-btn-outline" onClick={() => { trackCTAClick("begin_journey", "hero", "/"); navigate("/signup"); }}>
                  Begin Your Journey
                </button>
              </div>
        ...
        <section id="hv4-start">
          <div className="hv4-section-inner">
            ...
            <div className="hv4-start-ctas">
              <button type="button" className="hv4-btn-primary" onClick={() => { trackCTAClick("book_demo", "start", "/"); navigate("/book-a-demo"); }}>
                Book a Demo
              </button>
              <button type="button" className="hv4-btn-outline" onClick={() => { trackCTAClick("begin_journey", "start", "/"); navigate("/signup"); }}>
                Begin Your Journey
              </button>
            </div>
            ...
            <div className="hv4-why-now-grid">
              <div className="hv4-why-now-content">
                ...
                <div className="hv4-why-now-ctas">
                  <button type="button" className="hv4-btn-primary" onClick={() => { trackCTAClick("book_demo", "why_now", "/"); navigate("/book-a-demo"); }}>
                    Book a Demo
                  </button>
                  <button type="button" className="hv4-btn-outline" onClick={() => { trackCTAClick("begin_journey", "why_now", "/"); navigate("/signup"); }}>
                    Begin Your Journey
                  </button>
                </div>
        ...
        <section id="hv4-cta" ref={refCallbacks.cta} className={ctaInView ? "hv4-fade-in" : "hv4-fade-pre"}>
          ...
          <div className="hv4-cta-inner">
            ...
            <div className="hv4-cta-actions">
              <button type="button" className="hv4-btn-white" onClick={() => { trackCTAClick("book_demo", "footer_cta", "/"); navigate("/book-a-demo"); }}>
                Book a Demo
              </button>
              <button type="button" className="hv4-btn-outline-white" onClick={() => { trackCTAClick("begin_journey", "footer_cta", "/"); navigate("/signup"); }}>
                Begin Your Journey
              </button>
            </div>
