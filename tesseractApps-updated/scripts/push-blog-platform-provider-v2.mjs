...
const doc = {
  ...
  tags: ['NDIS', 'SIL', 'platform provider', 'mandatory registration', 'NDIS reform 2026', 'compliance', 'unregistered NDIS providers 2026'],
  ...
  featured: false,
  cta: {
    heading: 'Download our free Platform Provider Registration Guide',
    body: 'A plain-English walkthrough of what registration means for your platform and how to prepare. Or book a free demo to see how our software supports platform provider compliance at scale.',
    primaryLabel: 'Download the Guide',
    primaryUrl: '/guides/ndis-platform-provider-registration-guide',
