...
const Signup = () => {
  ...
  const handleNext = () => {
    ...
    setFormErrors({});
    trackFormStepComplete("signup", activeStep);
    setActiveStep((p) => p + 1);
  };
  ...
  const handleSubmit = () => {
    ...
    trackFormStepComplete("signup", activeStep);
    trackBeginJourneySubmit({ email: formData.email, phone: formData.phone, firstName: formData.firstName, lastName: formData.lastName });
    sendTextEmail(
