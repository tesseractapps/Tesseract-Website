...
const CountdownBar = () => {
  ...
  if (launched) {
    return (
      <div id="cd-bar" className="cd-bar--launched" role="banner" aria-label="Support Coordination launched">
        <canvas ref={canvasRef} id="cd-confetti" aria-hidden="true" />
        <div id="cd-bar-inner">
          <span className="cd-launched-emoji">🎉</span>
          <span className="cd-bar-label">Support Coordination is now live!</span>
